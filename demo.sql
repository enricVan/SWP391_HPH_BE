...
CREATE TABLE IF NOT EXISTS `hph_db`.`user` (
    ...
    CONSTRAINT `FKdl9dqp078pc03g6kdnxmnlqpc` FOREIGN KEY (`role_id`) REFERENCES `hph_db`.`role` (`role_id`)
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `hph_db`.`role_feature` (
    ...
    CONSTRAINT `FKkvt34970jxowf984hrm3loqlg` FOREIGN KEY (`role_id`) REFERENCES `hph_db`.`role` (`role_id`)
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `hph_db`.`student_request` (
    ...
    INDEX `FK93udbl2541hh53hiip8vaktjv` (`manager_id` ASC) VISIBLE,
    ...
    CONSTRAINT `FK1pvk2ipjpcwsxgvpqrqrc5r5h` FOREIGN KEY (`student_request_type_id`) REFERENCES `hph_db`.`student_request_type` (`student_request_type_id`),
    CONSTRAINT `FK93udbl2541hh53hiip8vaktjv` FOREIGN KEY (`manager_id`) REFERENCES `hph_db`.`manager` (`manager_id`),
    CONSTRAINT `FKlpxdaeqgtjh5gmqqksl59565n` FOREIGN KEY (`student_id`) REFERENCES `hph_db`.`student` (`student_id`)
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
-- -----------------------------------------------------
-- Table `hph_db`.`token`
-- -----------------------------------------------------
