...
public interface RequestApplicationRepository extends JpaRepository<RequestApplication, Long> {
    ...
    "AND (:requestTypeId is null or request_application_type_id = :requestTypeId)", nativeQuery = true)
    Page<RequestApplication> findAllAppReq(@Param("studentId") Long studentId, @Param("requestTypeId") Long id, Pageable pageable);
}
